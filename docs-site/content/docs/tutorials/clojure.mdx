---
title: Clojure
description: Configure realistic agents in Clojure with pipe, branch, revise, route, and EDN control outputs.
---
...
brief. Swap the adapter for `claude-cli`, `command-adapter`, or another adapter
when you want the same configured workflow to call a live agent system.
