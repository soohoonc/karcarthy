---
title: Clojure
description: Configure realistic agents in Clojure with pipe, map, iterate, bind, and EDN control outputs.
---
...
Clojure keeps the coordination graph as data. `map` gathers reviewer output;
the brief writer receives the combined mapped text in the next `pipe` step:
